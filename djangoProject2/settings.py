...
SECRET_KEY = 'django-insecure-_&h+(km8gi(w)!%u6-a)r*=ax2dtia2nv#82+e3pjvh#x9yxsz'
...
DATABASE_ROUTERS = ['develop.routers.SecondDatabaseRouter']
MIGRATION_MODULES = {
    'develop': None,  # Отключаем миграции для second_app
}
